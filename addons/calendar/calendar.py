    ...
    def write(self, cr, uid, ids, values, context=None):
        ...
        for event_id in ids:
            ...
            if '-' not in str(event_id):
                ...
                # Commit "calendar: allow change reccurence start/stop" from 9.0 seems to be compatible with 8.0
                # https://github.com/odoo/odoo/pull/10873/commits/33755f18826b1322283ed95dc045eb009be774ef
