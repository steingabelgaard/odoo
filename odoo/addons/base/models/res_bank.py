...
class ResPartnerBank(models.Model):
    ...
    # If we redefine constraint in another module, Odoo will still try to re-apply original constraint on base updates
    # (see https://github.com/odoo/odoo/issues/40740 )
    _sql_constraints = [
